...
var Feu = /** @class */ (function (_super) {
    __extends(Feu, _super);
    function Feu(nom, hp, atk) {
        return _super.call(this, nom, hp, atk, "Feu") || this;
    }
    Feu.prototype.attaque = function (pokemon) {
        ...
        else if (pokemon.get_type() === "Eau" || pokemon.get_type() === "Feu") {
            console.log(this.get_nom() + " ATTAQUE " + pokemon.get_nom());
