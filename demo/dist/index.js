...
var pokemon_1 = require("./pokemons/pokemon");
var eau_1 = require("./pokemons/types/eau");
var feu_1 = require("./pokemons/types/feu");
var plante_1 = require("./pokemons/types/plante");
...
// moto.displayMoto();
// POKEMON
var pokemonEau = new eau_1.Eau("Carapuce", 100, 13);
var pokemonFeu = new feu_1.Feu("Dracaufeu", 100, 19);
var pokemonPlante = new plante_1.Plante("Bulbizard", 100, 15);
var pokemonNormal = new pokemon_1.Pokemon("Normal", 100, 10, "Normal");
var tour = 1;
 ...
 * @param pokemon2
 */
var combat = function (pokemon1, pokemon2) {
